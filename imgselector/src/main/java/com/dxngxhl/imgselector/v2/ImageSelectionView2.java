...
import com.dxngxhl.imgselector.ImgShowActivity;
...
import com.dxngxhl.imgselector.itfc.RemoveListener;
...
//    public final static String SELECT_TAG = "ADD";
    ...
    private int imageAddRous = R.drawable.ic_imgselect_def_add,videoAddRous = R.drawable.ic_videoselect_def,closeRous = R.drawable.ic_close;
...
//
                ...
                if (imagePaths.get(position).getImagePath() == null){
                    ...
                    if (!imagePaths.get(position).isVideo()){
                        if (imageToView != null){
                            ...
                            mContxt.startActivity(new Intent(mContxt, ImgShowActivity.class).putExtra("path",imagePaths.get(position).getImagePath()));
                        }
                    }
                }
            }
     ...
     * @param loader
     */
    public ImageSelectionView2 setImageLoader(ImgSelectorLoader loader) {
        imageLoader = loader;
        return this;
    }
    public ImageSelectionView2 setImageToView(ImgShow toView){
        imageToView = toView;
        return this;
    }
    /**
     ...
     * @param imageChoose
     */
    public ImageSelectionView2 setImageChoose(ImgChooseItfc imageChoose) {
